...
namespace PREMIUM_6._0.Menu.Visuals
{
    public class Chams
    {
        ...
        #endregion
        #region 4DKEY
        public void EnableChams4dKey()
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.CHAMS3DKEY.dll";
            string glewpath = Path.Combine(Path.GetTempPath(), "CHAMS3DKEY.dll");
            ...
            {
                Notify("Chams 4D [F5] Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("Chams 4D [F5] Failed", "2000");
            }
        }
        #endregion
        #region Wukong
        public void EnableChamsWukong()
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.Wukong.dll";
            string glewpath = Path.Combine(Path.GetTempPath(), "Wukong.dll");
            ...
            if (hThread != IntPtr.Zero)
            {
                Notify("Chams Wukong Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("Chams Wukong Failed", "2000");
            }
        }
        #endregion
        #region Wukong Character
        public void EnableChamsWukongCharacter()
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.AntiWukonWhite.dll";
            string glewpath = Path.Combine(Path.GetTempPath(), "AntiWukonWhite.dll");
            ...
            if (hThread != IntPtr.Zero)
            {
                Notify("Chams Wukong Character Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("Chams Wukong Character Failed", "2000");
            }
        }
        #endregion
        #region HDRMap
        public void EnableHDRMap()
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.MapHdr.dll";
            ...
            if (hThread != IntPtr.Zero)
            {
                Notify("HDR Map Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("HDR Map Failed", "2000");
            }
        }
        #endregion
        #region CHAMS2D
        public void EnableChams2D()
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.SKIN2D.dll";
            string glewpath = Path.Combine(Path.GetTempPath(), "SKIN2D.dll");
            ...
            if (hThread != IntPtr.Zero)
            {
                Notify("Chams 2D Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("Chams 2D Failed", "2000");
            }
        }
        #endregion
        #region GLOW
        ...
        {
            string processName = "HD-Player";
            string glew = "PREMIUM_6._0.Properties.GLOW.dll";
            string glewpath = Path.Combine(Path.GetTempPath(), "GLOW.dll");
            ...
            if (hThread != IntPtr.Zero)
            {
                Notify("Chams Glow Enabled", "400");
            }
            else if (hThread == IntPtr.Zero)
            {
                Notify("Chams Glow Failed", "2000");
            }
        }
        #endregion
    }
